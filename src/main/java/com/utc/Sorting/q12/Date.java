...
public class Date implements Comparable<Date> {
  ...
  /**
   * Initializes new date specified as a string in form DD/MM/YYYY.
   * @param date the string representation of this date
   * @param format a dummy parameter to differentiate from other constructor
   * @throws IllegalArgumentException if this date is invalid
   */
  public Date(String date, boolean format) {
    String[] fields = date.split("/");
    if (fields.length != 3) {
      throw new IllegalArgumentException("Invalid date");
    }
  ...
  public static void main(String[] args) {
    ...
    StdOut.println("\nTesting new date formats:");

    // Test DD/MM/YYYY format
    Date date1 = new Date("25/12/2023", true);
    StdOut.println("DD/MM/YYYY format: " + date1);

    // Test DD-MM-YYYY format
    Date date2 = new Date("31-10-2023", 0);
    StdOut.println("DD-MM-YYYY format: " + date2);

    // Test DD...MM...YYYY... format
    Date date3 = new Date("15...04...2023", "");
    StdOut.println("DD...MM...YYYY... format: " + date3);
  }
